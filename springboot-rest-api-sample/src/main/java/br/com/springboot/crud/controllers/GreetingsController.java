...
public class GreetingsController {
	...
	/* Metódo Api Listar Usuarios */

	@GetMapping(value = "listausuarios")
	@ResponseBody
	public ResponseEntity<List<Usuario>> listaUsuarios() {

		List<Usuario> usuarios = usuarioRepository.findAll();/* Excecuta a consulta no banco de dados */

		return new ResponseEntity<List<Usuario>>(usuarios, HttpStatus.OK); /* Retorna lista em Json */
	}
	
	/* Metódo Api Salvar Usuário */
	...
	/* Metódo Api Buscar Usuario por Id */
